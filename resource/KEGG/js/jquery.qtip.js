		...
		if(corner.abbrev() === 'c') {
			...
			while(newWidth > 0 && newHeight > 0 && compareX > 0 && compareY > 0)
			{
				...
				i = coords.length; while(i--)
				{
					...
					(corner.x === RIGHT && realX <= comparex)="" ||="" (corner.x="==" center="" &&="" (realx="" <="" comparex="" realx=""> (result.width - compareX))) ||
					(corner.y === TOP && realY >= compareY) ||
					(corner.y === BOTTOM && realY <= comparey)="" ||="" (corner.y="==" center="" &&="" (realy="" <="" comparey="" realy=""> (result.height - compareY)))) {
						coords.splice(i, 1);
					}
				}
			}
 ...
 */
BGIFRAME = '<iframe class="qtip-bgiframe" frameborder="0" tabindex="-1" src="javascript:\'\';" '="" +="" style="display:block; position:absolute; z-index:-1; filter:alpha(opacity=0); ' +
...
</div></=></=></div></canvas></div></qtipvml:'+tag+'></canvas></span></a></div></div></div></div>